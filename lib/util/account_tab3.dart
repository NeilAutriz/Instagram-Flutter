...
/*This Dart code modifies the AccountTab3 widget. It builds a GridView with 3 columns and displays user posts
 stored in the userPosts list. Each image is loaded using Image.asset with BoxFit.cover to ensure they cover 
 their containers properly, and Padding is added around each image for spacing. */

// Modify the AccountTab3 widget
